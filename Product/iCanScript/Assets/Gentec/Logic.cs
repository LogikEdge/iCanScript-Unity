...
namespace Genetec.Logic {
	...
	public static class Selectors {
		public static bool   Choice(bool trueValue,  bool falseValue,  bool selector) { return selector ? trueValue : falseValue; }
		public static float  Choice(float trueValue,  float falseValue,  bool selector) { return selector ? trueValue : falseValue; }
		public static int    Choice(int trueValue,    int falseValue,    bool selector) { return selector ? trueValue : falseValue; }
		public static string Choice(string trueValue, string falseValue, bool selector) { return selector ? trueValue : falseValue; }
		public static Object Choice(Object trueValue, Object falseValue, bool selector) { return selector ? trueValue : falseValue; }
	}
}