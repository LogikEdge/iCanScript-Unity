...
namespace iCanScript.Engine.GeneratedCode {
    ...
    public class GameController : MonoBehaviour {
        ...
        [iCS_InOutPort]
        public  iCS_Oscillator oscillator=  new iCS_Oscillator();
        [iCS_InOutPort]
        ...
        public  void Update() {
            ...
            bool theInvOut;
            var theOscillatorPulse= oscillator.Oscillate(iCS_Math.Mul(hazardCount, spawnWait), waveWait, theIsElapsed, out theInvOut);
            if(pulseGenerator.GeneratePulse(spawnWait, theOscillatorPulse, true)) {
