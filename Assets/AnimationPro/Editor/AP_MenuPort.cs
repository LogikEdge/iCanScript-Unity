...
public class AP_MenuPort {
    ...
    // ----------------------------------------------------------------------
    [MenuItem("CONTEXT/AnimationPro/Port/Add Input")]
    ...
    // ----------------------------------------------------------------------
    [MenuItem("CONTEXT/AnimationPro/Port/Add Output")]
    ...
    // ----------------------------------------------------------------------
    [MenuItem("CONTEXT/AnimationPro/Port/Create Property/Float")]
...
//        AP_Port selectedObject= context.SelectedObject as AP_Port;
    ...
    [MenuItem("CONTEXT/AnimationPro/Port/Create Property/Float",true)]
