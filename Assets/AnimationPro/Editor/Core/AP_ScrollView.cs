...
public class AP_ScrollView {
    ...
    public void Update(Rect _windowPosition, Rect _rootNodePosition) {
        ...
        ScrollWindow= new Rect(0, AP_EditorConfig.EditorWindowToolbarHeight, _windowPosition.width, _windowPosition.height-AP_EditorConfig.EditorWindowToolbarHeight);

        // Update scroll viewport.
        Rect graphRect= new Rect(_rootNodePosition.x - AP_EditorConfig.GutterSize,
                                 _rootNodePosition.y - AP_EditorConfig.GutterSize,
                                 _rootNodePosition.width + 2*AP_EditorConfig.GutterSize,
                                 _rootNodePosition.height + 2*AP_EditorConfig.GutterSize);
