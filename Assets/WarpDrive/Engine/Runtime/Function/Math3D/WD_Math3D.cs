...
public class WD_Math3D {
    [WD_Function] public static int     AddInt(int a, int b)             { return a+b; }
    [WD_Function] public static float   AddFloat(float a, float b)       { return a+b; }
    [WD_Function] public static Vector2 AddVector2(Vector2 a, Vector2 b) { return a+b; }
    [WD_Function] public static Vector3 AddVector3(Vector3 a, Vector3 b) { return a+b; }
    [WD_Function] public static Vector4 AddVector4(Vector4 a, Vector4 b) { return a+b; }
    ...
    [WD_Function] public static void    FromVector4(Vector4 v, out float x, out float y, out float z, out float w) { x= v.x; y= v.y; z= v.z; w= v.w; }

    [WD_Function] public static Vector2 ToVector2(float x, float y)                   { return new Vector2(x,y); }
    [WD_Function] public static Vector3 ToVector3(float x, float y, float z)          { return new Vector3(x,y,z); }
    [WD_Function] public static Vector4 ToVector4(float x, float y, float z, float w) { return new Vector4(x,y,z,w); }
