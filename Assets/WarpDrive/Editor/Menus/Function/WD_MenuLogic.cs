...
public class WD_MenuBoolean {
    ...
    public static void AddNodeCBoolean(MenuCommand command) {
        ...
        context.EditorObjects.CreateInstance<WD_CBoolean>("", parent.InstanceId, context.GraphPosition);
    ...
    public static void AddNodeNot(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_Not>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
    ...
    public static void AddNodeAnd(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_And>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
    ...
    public static void AddNodeOr(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_Or>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
    ...
    public static void AddNodeXor(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_Xor>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
    ...
    public static void AddNodeDecoder2(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_Decoder2>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
    ...
    public static void AddNodeDecoder4(MenuCommand command) {
        WD_MenuContext context= command.context as WD_MenuContext;
        WD_EditorObject parent= context.SelectedObject;
        context.EditorObjects.CreateInstance<WD_Decoder4>("", parent.InstanceId, context.GraphPosition);
        WD_MenuContext.DestroyImmediate(context);
    }
