...
[System.Serializable]
public enum UK_DisplayOptionEnum { Normal, Minimized, Folded, Hidden }
...
public static partial class WD {
    ...
    public static bool IsHidden           (UK_EditorObject obj) { return obj.DisplayOption == UK_DisplayOptionEnum.Hidden; }
    ...
    public static void Hide               (UK_EditorObject obj) { obj.DisplayOption= UK_DisplayOptionEnum.Hidden; }
}
