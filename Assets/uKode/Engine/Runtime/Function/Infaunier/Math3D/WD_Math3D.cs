...
public class WD_Math3D {
    ...
    [WD_Function(Icon="WD_JoinIcon.psd")] public static Vector2 ToVector(float x, float y)                   { return new Vector2(x,y); }
    [WD_Function(Icon="WD_JoinIcon.psd")] public static Vector3 ToVector(float x, float y, float z)          { return new Vector3(x,y,z); }
    [WD_Function(Icon="WD_JoinIcon.psd")] public static Vector4 ToVector(float x, float y, float z, float w) { return new Vector4(x,y,z,w); }
    ...
    [WD_Function(Name="Random",Icon="WD_RandomIcon.png")] public static float   Random(float scale)         { return scale*UnityEngine.Random.value; }
    [WD_Function(Name="Random",Icon="WD_RandomIcon.png")] public static Vector2 RandomVector2(float scale)  { return scale*UnityEngine.Random.insideUnitCircle; }
    [WD_Function(Name="Random",Icon="WD_RandomIcon.png")] public static Vector3 RandomVector3(float scale)  { return scale*UnityEngine.Random.insideUnitSphere; }
    ...
    [WD_Function] public static float Magnitude(Vector2 v)   { return v.magnitude; }
    [WD_Function] public static float Magnitude(Vector3 v)   { return v.magnitude; }
    [WD_Function] public static float Magnitude(Vector4 v)   { return v.magnitude; }
}
