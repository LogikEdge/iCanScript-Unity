...
public partial class iCS_EditorObject {
    ...
    public void UserDragTo(Vector2 newPosition) {
        if(IsNode) {
            ...
            Debug.LogWarning("Port UserDragTo not supported yet !!!");
        }
    }
    // ----------------------------------------------------------------------
    ...
    public void ResolveCollisionOnChildren(Vector2 delta) {
        ...
        iCS_EditorObject[] children= BuildListOfChildren(c=> c.IsVisible && c.IsNode && !c.IsFloating);
    ...
    public bool ResolveCollisionBetweenTwoNodes(iCS_EditorObject otherNode, Vector2 delta) {
        ...
        if(!DoesCollideWithGutter(otherNode)) return false;
    ...
    public bool DoesCollide(iCS_EditorObject otherNode) {
        return Math3D.DoesCollide(this.GlobalRect, otherNode.GlobalRect);
    }
    // ----------------------------------------------------------------------
    // Returns if the given rectangle collides with the node.
    public bool DoesCollideWithGutter(iCS_EditorObject otherNode) {
