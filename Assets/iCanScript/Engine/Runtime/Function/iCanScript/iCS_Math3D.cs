...
public class iCS_Math3D {
    ...
    [iCS_Function(Icon="iCS_SplitIcon.psd")] public static void    FromVector2(Vector2 v, out float x, out float y)                           { x= v.x; y= v.y; }
    [iCS_Function(Icon="iCS_SplitIcon.psd")] public static void    FromVector3(Vector3 v, out float x, out float y, out float z)              { x= v.x; y= v.y; z= v.z; }
    [iCS_Function(Icon="iCS_SplitIcon.psd")] public static void    FromVector4(Vector4 v, out float x, out float y, out float z, out float w) { x= v.x; y= v.y; z= v.z; w= v.w; }

    [iCS_Function(Icon="iCS_JoinIcon.psd")] public static Vector2 ToVector2(float x, float y)                   { return new Vector2(x,y); }
    [iCS_Function(Icon="iCS_JoinIcon.psd")] public static Vector3 ToVector3(float x, float y, float z)          { return new Vector3(x,y,z); }
    [iCS_Function(Icon="iCS_JoinIcon.psd")] public static Vector4 ToVector4(float x, float y, float z, float w) { return new Vector4(x,y,z,w); }
    ...
    [iCS_Function] public static Vector2 ScaleVector2(float scale, Vector2 v) { return scale*v; }
    [iCS_Function] public static Vector3 ScaleVector3(float scale, Vector3 v) { return scale*v; }
    [iCS_Function] public static Vector4 ScaleVector4(float scale, Vector4 v) { return scale*v; }

    [iCS_Function] public static Vector2 Scale2Vector2(float s1, float s2, Vector2 v) { return s1*s2*v; }
    [iCS_Function] public static Vector3 Scale2Vector3(float s1, float s2, Vector3 v) { return s1*s2*v; }
    [iCS_Function] public static Vector4 Scale2Vector4(float s1, float s2, Vector4 v) { return s1*s2*v; }
    
    [iCS_Function] public static float Magnitude(Vector2 v)   { return v.magnitude; }
    [iCS_Function] public static float Magnitude(Vector3 v)   { return v.magnitude; }
    [iCS_Function] public static float Magnitude(Vector4 v)   { return v.magnitude; }
}
