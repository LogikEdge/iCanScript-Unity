...
public class iCS_SetInstanceField : iCS_FieldBase {
    ...
    // ----------------------------------------------------------------------
    public iCS_SetInstanceField(int instanceId, string name, FieldInfo fieldInfo, SSContext context, int priority, int nbOfEnables)
    : base(instanceId, name, fieldInfo, context, priority, 1, nbOfEnables) {
    }
