...
public struct Int {
    ...
    [iCS_Function(Return="value == b")]  public bool IsEqual(int b)            { return myValue==b; }
    [iCS_Function(Return="value != b")]  public bool IsNotEqual(int b)         { return myValue!=b; }
    [iCS_Function(Return="value > b")]    public bool IsGreaterThen(int b)      { return myValue > b; }
    [iCS_Function(Return="value < b")]    public bool IsSmallerThen(int b)      { return myValue < b; }
    [iCS_Function(Return="value >= b")]  public bool IsGreaterOrEqualTo(int b) { return myValue >= b; }
    [iCS_Function(Return="value <= b")]  public bool IsSmallerOrEqualTo(int b) { return myValue <= b; }    
