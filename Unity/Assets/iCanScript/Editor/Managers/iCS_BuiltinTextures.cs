...
public static class iCS_BuiltinTextures {
	...
	static void BuildEndPortIcons(Color typeColor) {
		Texture2D inPortTemplate= new Texture2D(kPortIconHeight, kPortIconHeight, TextureFormat.ARGB32);
		Texture2D outPortTemplate= new Texture2D(kPortIconHeight, kPortIconHeight, TextureFormat.ARGB32);
        ...
        myInEndPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
        myOutEndPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
	...
	static void BuildRelayPortIcons(Color typeColor) {
        ...
        myInRelayPortIcon = new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
        myOutRelayPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
    ...
    static void BuildControlPortIcons() {
        ...
        myInTriggerPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
        myOutTriggerPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
    ...
    static void BuildTransitionPortIcons() {
        // Create textures.
        myInTransitionPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
        myOutTransitionPortIcon= new Texture2D(kPortIconWidth, kPortIconHeight, TextureFormat.ARGB32);
...
//        if(myMaximizeIcon != null) Texture2D.DestroyImmediate(myMaximizeIcon);
        myMaximizeIcon= new Texture2D(sizeInt, sizeInt, TextureFormat.ARGB32);
...
//        }
    ...
    static void BuildMinimizeIcon() {        
        ...
        myMinimizeIcon= new Texture2D(sizeInt, sizeInt, TextureFormat.ARGB32);
    ...
    static void BuildFoldIcon() {
		...
		myFoldIcon= new Texture2D(textureSize, textureSize, TextureFormat.ARGB32);
    ...
    static void BuildUnfoldIcon() {
		...
		myUnfoldIcon= new Texture2D(textureSize, textureSize, TextureFormat.ARGB32);
    ...
    static void BuildNavigationHistoryIcons() {
		...
		myForwardNavigationHistoryIcon= new Texture2D(textureSize, textureSize, TextureFormat.ARGB32);
		myBackwardNavigationHistoryIcon= new Texture2D(textureSize, textureSize, TextureFormat.ARGB32);
