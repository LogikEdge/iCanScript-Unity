...
namespace iCanScript { namespace Editor {
    ...
    public static class PublicInterfaceController {
        ...
        // Initialization
        // ----------------------------------------------------------------------
        static PublicInterfaceController() {
            // -- Verify proper creation order --
            if(SceneController.VisualScriptsInScene == null) {
            ...
            SystemEvents.OnSceneChanged    += OnSceneChange;
            SystemEvents.OnHierarchyChanged+= OnSceneLoad;
            SystemEvents.OnProjectChanged  += OnSceneLoad;
            // -- Events to refresh visual script information --
    		SystemEvents.OnVisualScriptSaved			   += OnVisualScriptSaved;
            SystemEvents.OnVisualScriptUndo                += OnVisualScriptUndo;
        ...
        public static void Shutdown() {
            ...
            SystemEvents.OnSceneChanged    -= OnSceneLoad;
            SystemEvents.OnHierarchyChanged-= OnSceneLoad;
            SystemEvents.OnProjectChanged  -= OnSceneLoad;
        ...
        static ReferenceToDefinition[] ScanForPublicVariables() {
            ...
            P.forEach(vs=> {
                ...
                SceneController.VisualScriptsInOrReferencedByScene
            );
    				...
    				definitions.ForEach(
    					o=> {
    						if(qualifiedType != o.EngineObject.QualifiedType) {
    							...
    							ErrorController.AddError(kServiceId, errorMsg, defVisualScript, defEngineObject.InstanceId);
    							ErrorController.AddError(kServiceId, errorMsg, o.VisualScript, o.EngineObject.InstanceId);
    ...
    //							ErrorController.AddError(kServiceId, errorMsg, vs, engObj.InstanceId);
    //							ErrorController.AddError(kServiceId, errorMsg, o.VisualScript, o.EngineObject.InstanceId);
    //                            group.IsDefinitionsErrorFree= false;
    						}
    					}
