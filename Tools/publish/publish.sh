...
find $DEMO_DIR >>engineFilesToExclude
...
rsync -av $DEMO_DIR $PUBLISH_PRODUCT_DIR >/dev/null
rsync -av $ASSET_STORE_TOOLS $PUBLISH_ASSETS_DIR >/dev/null
